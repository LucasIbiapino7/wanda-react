...
export default function ClassroomDetailsPage() {
  ...
  const handleArchive = () => {
    requestConfirmation({
      ...
      message:
        "Tem certeza que deseja arquivar esta turma? Torneios abertos ou em andamento serão cancelados.",
  ...
  return (
    <main className="classroom-details-page">
      <nav
        className="classroom-details-breadcrumb"
        aria-label="Navegação da turma"
      >
        <button type="button" onClick={() => navigate("/classrooms")}>
          Turmas
        </button>
      ...
      <section className="classroom-details-hero">
        <div
          className={`classroom-details-hero__accent classroom-details-hero__accent--${gameKey}`}
        />
        ...
        <div className="classroom-details-hero__content">
          <div className="classroom-details-hero__main">
            <div className="classroom-details-hero__badges">
              <span
                className={
                  isArchived ? "status-badge archived" : "status-badge active"
                }
              >
        ...
        <section className="classroom-details-card">
          <div className="classroom-members-header">
            <div>
              <h2>Membros</h2>
              <p>
                {members.length} alunos nesta página · {submittedCount}{" "}
                submeteram
              </p>
            </div>
          </div>
          ...
          {canManage && !isArchived && (
            <aside className="add-member-card">
              ...
              <form
                className="classroom-add-student"
              ...
              >
                ...
                <span className="form-hint">
                  O aluno precisa ter uma conta no Wanda.
                </span>
                <button
                  className="btn-add"
                  type="submit"
              ...
              <p className="add-member-hint">
                Você também pode compartilhar o código de acesso e deixar os
                alunos entrarem por conta própria.
              </p>
            </aside>
          )}
                      ...
                      {canManage && (
                        <td>
                          <button
                            ...
                            disabled={
                              removingStudentId === member.userId || isArchived
                            }
                          >
          ...
          {membersTotalPages > 1 && (
            <div className="classroom-members-pagination">
              ...
              <button
                type="button"
                disabled={
                  membersPage + 1 >= membersTotalPages || membersLoading
                }
                onClick={() => fetchMembers(membersPage + 1)}
              >
                Próxima
