...
import InstructionsModal from "../../components/SendFunction/InstructionsModal.jsx";
import SuccessModal from "../../components/SendFunction/SuccessModal.jsx";
...
export default function GameLayoutTest() {
        ...
        <div className="editor-feedback-container">
          ...
          <div className="feedback-space" aria-busy={isProcessing}>
            ...
            {activeTab === 'description' ? (
              ...
              <div className="assistantAI-container">
                {!assistantStyle && (
